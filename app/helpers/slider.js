...
export default class Slideshow extends Component {
  constructor(props) {
    ...
    this.state = {
      position: 0,
      height: scale(300),//Dimensions.get('window').width * (8 / 9),
      width: scale(300),//Dimensions.get('window').width,
      scrolling: false,
    };
  }
  ...
  render() {
    const width = scale(375);this.state.width;
    const height = scale(296);//this.props.height || this.state.height;
    const position = this._getPosition();
    return (
      <View style={[
